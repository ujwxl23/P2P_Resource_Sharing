...
describe("FileShare", function () {
 ...
 const token=await ethers.getContractFactory("FileShareToken");
    ...
    await fileContract.removeDevice(1,1);
 ...
 const token=await ethers.getContractFactory("FileShareToken");
    ...
    let Request = await fileContract.ViewDeviceRequestByRequestor(await acc1.getAddress(), 1);
      console.log(Request);
        let Request = await fileContract.ViewDeviceRequestByRequestor(await acc1.getAddress(), 2);
    console.log(Request);
    });
