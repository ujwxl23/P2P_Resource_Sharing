...
describe("FileShare", function () {
 ...
 const token=await ethers.getContractFactory("FileShareToken");
    ...
    const fileContract = await file.deploy(await tokenContract.address,fixedStake,fixedStake.toString(),utils.parseUnits("0.01"));
    ...
    await fileContract.createProvide("Helping", "Intel", 20, 1,);
