...
contract FileShare is ERC20, Ownable {
    ...
    function makeRequestToProvider(uint256 _proId, uint256 _spaceReq, string  calldata _deviceNameReq) public {
    ...
    function getAllAvailableDevices(uint256 _proIdAvailable) public view returns(string[] memory availableDevices){
